...
class Admin
{
    ...
    public function enqueue_assets(string $hook_suffix): void
    {
        ...
        $style = $this->manifest->find_entry_by_name('admin-style');
        $tailwind_style = $this->manifest->find_entry_by_name('admin-tailwind-style');
    ...
    private function get_tabs(): array
    {
        $tabs = [
            ...
            'general' => [
                ...
                'subtitle' => __('Manage booking analytics tracking.', 'barefoot-engine'),
