...
<section class="be-panel">
    <div class="be-section">
        ...
        <div class="be-color-grid">
            <label class="be-field be-field-color">
                <span class="be-field-label"><?php echo esc_html__('Primary', 'barefoot-engine'); ?></span>
            ...
            <label class="be-field be-field-color">
                <span class="be-field-label"><?php echo esc_html__('Secondary', 'barefoot-engine'); ?></span>
                <span class="be-color-input-wrap">
            ...
            <label class="be-field be-field-color">
                <span class="be-field-label"><?php echo esc_html__('Accent', 'barefoot-engine'); ?></span>
                <span class="be-color-input-wrap">
    ...
    <div class="be-section">
        ...
        <div class="be-field-grid">
            <label class="be-field">
                <span class="be-field-label"><?php echo esc_html__('Heading Font', 'barefoot-engine'); ?></span>
                <select>
            ...
            <label class="be-field">
                <span class="be-field-label"><?php echo esc_html__('Body Font', 'barefoot-engine'); ?></span>
                <select>
                    <option><?php echo esc_html__('Inter', 'barefoot-engine'); ?></option>
        ...
        <label class="be-field">
            <span class="be-field-label be-field-label-row">
    ...
    <div class="be-section">
        ...
        <label class="be-field">
            <span class="screen-reader-text"><?php echo esc_html__('Custom CSS', 'barefoot-engine'); ?></span>
            <textarea rows="6" placeholder=".example-class {&#10;  color: #000;&#10;}"></textarea>
            <span class="be-field-help"><?php echo esc_html__('Add custom CSS rules to override default styles. Use !important sparingly.', 'barefoot-engine'); ?></span>
        </label>
    </div>
